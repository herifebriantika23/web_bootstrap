...
<html lang="en" data-bs-theme="auto">
  ...
  <body>
    ...
    ?>
    <header
      class="navbar sticky-top bg-primary flex-md-nowrap p-0"
      data-bs-theme="dark"

    >
      <a
        class="navbar-brand col-md-3 col-lg-2 px-3 fs-6 text-white bg-primary shadow"
      ...
      <div class="row">
        ...
        >
          ...
          >
            ...
            <small class="text-muted" style="font-family: 'PT Serif', sans-serif;">Selamat datang kembali, senang bisa bertemu dengan anda</small>
          </div>
          ...
          <div class="header">
            ...
            >
              <h3 class="fs-4" style="font-family: 'Poppins', sans-serif;">Dashboard</h3>
            </div>
          </div>
          ...
          <section class="my-5">
            <div class="container">
              <div
                class="row justify-content-around flex-md-row d-flex flex-column flex-md-row"
              >
                <div class="col-md-5 text-center">
                  <img
                    src="asset/content/dashboard.jpg"
                    alt="home"
                    class="rounded-circle img-thumbnail img-fluid h-75 shadow"
                  />
                </div>
                <div class="col-md-7 text-center my-4">
                  <h2 style="font-family: 'Poppins', sans-serif;">I Kadek Heri Febriantika</h2>
                  <p class="text-muted" style="font-family: 'PT Serif', sans-serif;">
                    Mahasiswa UHN I Gusti Bagus Sugriwa Denpasar
                  </p>
                  <p style="font-family: 'PT Serif', sans-serif;">
                    Saya adalah mahasiswa dari Kampus Universitas Hindu Negeri I
                    Gusti Bagus Sugriwa Denpasar aktif yang sedang menempuh
                    pendidikan di bidang informatika. Saya memiliki minat dalam
                    mempelajari website,dan selalu bersemangat untuk belajar
                    hal-hal baru.
                  </p>
                </div>
              </div>
